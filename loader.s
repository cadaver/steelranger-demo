...
InitLoader:     lda #$02
                ...
                lda #$0b
                sta $d011                       ;Blank screen + ensure correct finescroll for data transfer
...
IL_WaitDataLow: lda status                      ;If error, it's probably IDE64
                ...
                beq IL_NoFastLoad
                lda $a5                         ;If serial delay was unchanged, VICE's true drive emu (note: JiffyDos also does this)
                cmp #$aa
                beq IL_NoSerial
                bne IL_NoFastLoad
...
IL_CopyLoaderCode:
                ...
                pha
                lda #<loaderCodeEnd
                jmp LoadFile                    ;Load loading picture & main part (overwrites loader init)
...
FL_ClearSpritesJsr:                             ;This will be changed by game to clear sprites before transfer
                jsr ClearSpritesDummy
FL_FillBufferWait:
